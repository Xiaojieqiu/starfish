...
class ImageStack:
    ...
    def __init__(self, image_partition):
        ...
        shape = [
            self._get_dimension_shape(axis_name)
    ...
    def _get_dimension_shape(self, dimension: Indices):
    ...
    @property
    def num_hybs(self):
        return self._get_dimension_shape(Indices.HYB)

    @property
    def num_chs(self):
        return self._get_dimension_shape(Indices.CH)

    @property
    def num_zlayers(self):
        return self._get_dimension_shape(Indices.Z)
