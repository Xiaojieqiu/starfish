...
def test_round_trip_synthetic_data():
    ...
    codebook.decode_euclidean(calculated_intensities, max_distance=1)  # pass-through distance
...
def test_medium_synthetic_stack():
    ...
    calculated_intensities = gsd.find(spots)
    codebook.decode_euclidean(calculated_intensities, max_distance=1)  # pass through filter
